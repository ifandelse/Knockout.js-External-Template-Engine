...
void 0||this.templateUrl==""?a:this.templateUrl+"/"+a};this.setOptions=function(a){$.extend(this,a)}},ko.ExternaljQueryTemplateEngine.prototype=new ko.templateEngine,ko.externaljQueryTemplateEngine=new ko.ExternaljQueryTemplateEngine,ko.setTemplateEngine(ko.externaljQueryTemplateEngine);
})(window);                  
