        ...
        function(factory) {
            ...
            ko.utils = new(function() {
                ...
                return {
                    ...
                    registerEventHandler: function(element, eventType, handler) {
                        ...
                        } else if (typeof element.addEventListener == "function") element.addEventListener(eventType, handler, false);
                    ...
                    triggerEvent: function(element, eventType) {
                        ...
                        if (typeof jQuery != "undefined") {
                            ...
                            if (eventType == "click") {
                                if ((element.tagName == "INPUT") && ((element.type.toLowerCase() == "checkbox") || (element.type.toLowerCase() == "radio"))) element.checked = element.checked !== true;
                            }
                    ...
                    outerHTML: function(node) {
                        ...
                        if (ieVersion === undefined) {
                            ...
                            if (typeof nativeOuterHtml == "string") return nativeOuterHtml;
                        }
            ...
            ko.dependencyDetection = (function() {
                ...
                return {
                    ...
                    registerDependency: function(subscribable) {
                        if (!ko.isSubscribable(subscribable)) throw "Only subscribable things can act as dependencies";
                        if (_frames.length > 0) {
            ...
            (function() {
                ...
                ko.selectExtensions = {
                    readValue: function(element) {
                        ...
                        } else if (element.tagName == 'SELECT') return element.selectedIndex >= 0 ? ko.selectExtensions.readValue(element.options[element.selectedIndex]) : undefined;
            ...
            (function() {
                ...
                function nodeArrayToText(nodeArray, cleanNodes) {
                    ...
                    for (var i = 0, j = nodeArray.length; i < j; i++) {
                        if (cleanNodes) ko.utils.domNodeDisposal.cleanNode(nodeArray[i]);
                ...
                ko.virtualElements = {
                    ...
                    nextSibling: function(node) {
                        if (!isStartComment(node)) {
                            if (node.nextSibling && isEndComment(node.nextSibling)) return undefined;
                    ...
                    normaliseVirtualElementDomStructure: function(elementVerified) {
                        ...
                        if (!htmlTagsWithOptionallyClosingChildren[elementVerified.tagName.toLowerCase()]) return;
            ...
            (function() {
                ...
                function applyBindingsToNodeAndDescendantsInternal(viewModel, nodeVerified, isRootNodeForBindingContext) {
                    ...
                    if (shouldApplyBindings) shouldBindDescendants = applyBindingsToNodeInternal(nodeVerified, null, viewModel, isRootNodeForBindingContext).shouldBindDescendants;
                ...
                function applyBindingsToNodeInternal(node, bindings, viewModelOrBindingContext, isRootNodeForBindingContext) {
                    ...
                    new ko.dependentObservable(
                        ...
                        function() {
                            ...
                            if (isRootNodeForBindingContext) ko.storedBindingContextForNode(node, bindingContextInstance);
                ...
                ko.applyBindingsToDescendants = function(viewModel, rootNode) {
                    if (rootNode.nodeType === 1) applyBindingsToDescendantsInternal(viewModel, rootNode);
                };
            ...
            ko.bindingHandlers['value'] = {
                    ...
                    ko.utils.arrayForEach(eventsToCatch, function(eventName) {
                        ...
                        ko.utils.registerEventHandler(element, eventName, function() {
                            runEventHandler(function() {
                                ...
                                if (ko.isWriteableObservable(modelValue)) modelValue(elementValue);
                                else {
                                    var allBindings = allBindingsAccessor();
                ...
                'update': function(element, valueAccessor) {
                    ...
                    if ((element.tagName == "SELECT") && (element.length > 0)) ensureDropdownSelectionIsConsistentWithModelValue(element, newValue, /* preferModelValue */ false);
                }
            };

            ko.bindingHandlers['options'] = {
                'update': function(element, valueAccessor, allBindingsAccessor) {
                    if (element.tagName != "SELECT") throw new Error("options binding applies only to SELECT elements");
            ...
            ko.bindingHandlers['selectedOptions'] = {
                getSelectedValuesFromSelectNode: function(selectNode) {
                    ...
                    for (var i = 0, j = nodes.length; i < j; i++) {
                        var node = nodes[i];
                        if ((node.tagName == "OPTION") && node.selected) result.push(ko.selectExtensions.readValue(node));
                    }
                    return result;
                },
                'init': function(element, valueAccessor, allBindingsAccessor) {
                    ko.utils.registerEventHandler(element, "change", function() {
                        var value = valueAccessor();
                        if (ko.isWriteableObservable(value)) value(ko.bindingHandlers['selectedOptions'].getSelectedValuesFromSelectNode(this));
                        else {
                            var allBindings = allBindingsAccessor();
                            if (allBindings['_ko_property_writers'] && allBindings['_ko_property_writers']['value']) allBindings['_ko_property_writers']['value'](ko.bindingHandlers['selectedOptions'].getSelectedValuesFromSelectNode(this));
                        }
                    });
                },
                'update': function(element, valueAccessor) {
                    if (element.tagName != "SELECT") throw new Error("values binding applies only to SELECT elements");
                    ...
                    if (newValue && typeof newValue.length == "number") {
                        ...
                        for (var i = 0, j = nodes.length; i < j; i++) {
                            var node = nodes[i];
                            if (node.tagName == "OPTION") ko.utils.setOptionNodeSelectionState(node, ko.utils.arrayIndexOf(newValue, ko.selectExtensions.readValue(node)) >= 0);
                        }
                    }
                }
            };
                ...
                'update': function(element, valueAccessor, allBindingsAccessor) {
                    ...
                    for (var attrName in value) {
                        if (typeof attrName == "string") {
                            ...
                            if ((attrValue === false) || (attrValue === null) || (attrValue === undefined)) element.removeAttribute(attrName);
            ...
            ko.bindingHandlers['hasfocus'] = {
                'init': function(element, valueAccessor, allBindingsAccessor) {
                    var writeValue = function(valueToWrite) {
                        var modelValue = valueAccessor();
                        if (valueToWrite == ko.utils.unwrapObservable(modelValue)) return;
            ...
            return (function() { return { " + rewrittenDataBindAttributeValue + " } })() \
                ...
                return {
                    ensureTemplateIsRewritten: function(template, templateEngine) {
                        if (!templateEngine['isTemplateRewritten'](template)) templateEngine['rewriteTemplate'](template, function(htmlString) {
            ...
            (function() {
                ...
                ko.templateSources.domElement.prototype['text'] = function( /* valueToWrite */ ) {
                    if (arguments.length == 0) {
                        ...
                        if (this.domElement.tagName.toLowerCase() == "script") this.domElement.text = valueToWrite;
                        else ko.utils.setHtml(this.domElement, valueToWrite);
                    }
                };
            ...
            (function() {
                ...
                ko.renderTemplateForEach = function(template, arrayOrObservableArray, options, targetNode, parentBindingContext) {
                    ...
                    var activateBindingsCallback = function(arrayValue, addedNodesArray) {
                        ...
                        if (options['afterRender']) options['afterRender'](addedNodesArray, bindingContext['$data']);
                    };
            ...
            (function() {
                ...
                ko.utils.setDomNodeChildrenFromArrayMapping = function(domNode, array, mapping, options, callbackAfterAddingNodes) {
                    ...
                    for (var i = 0, j = editScript.length; i < j; i++) {
                        switch (editScript[i].status) {
                            ...
                            case "added":
                                ...
                                if (callbackAfterAddingNodes) callbackAfterAddingNodes(valueToMap, mappedNodes);
                                break;
                        }
                    }
                    ...
                    if (!invokedBeforeRemoveCallback) ko.utils.arrayForEach(nodesToDelete, function(node) {
